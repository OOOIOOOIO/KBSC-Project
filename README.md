...
#### 아쉬웠던 점
- Spring Boot를 사용해 처음 개발해 보았다. 훨씬 편하다. 하지만… 혼자 Web 개발 Frontend와 Backend를 개발하기에 준비할 시간이 너무 촉박하했다…
- 시간이 촉박해서 원하는 기능들을 다 구현하지 못하고 큰 로직들만 개발했다. 아쉽다. 코드도 더럽고….후음 나중에 싹 다 리팩토링을 해야겠다.
- Spring Security를 처음 사용해서 개인 정보를 암호화했다! 신기했다. 암호화에만 사용하여 살짝 아쉬웠다!
